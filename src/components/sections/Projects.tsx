      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group theme-bg-surface rounded-xl overflow-hidden backdrop-blur-sm border transition-all duration-300"
              style={{ borderColor: 'var(--border-color)' }}
            >
              <div className="relative h-48 overflow-hidden">
                <div className="absolute inset-0 z-10" style={{ background: 'linear-gradient(to bottom, transparent, var(--bg-main))' }} />
                <img
                  src={project.image}
                  alt={project.title}
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="inline-flex items-center px-4 py-2 rounded-lg transition-colors theme-text-secondary"
